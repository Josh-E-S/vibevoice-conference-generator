...
VOICE_INFO = {
    ...
    # LibriVox solo readers (all LibriVox recordings are public domain).
    "Ishmael": {"gender": "M", "tags": ["Resonant", "Epic"], "color": "#35618E"},
    "Traveller": {"gender": "M", "tags": ["Clear", "Adventurer"], "color": "#5E5A8C"},
    "Dublin": {"gender": "M", "tags": ["Irish", "Lilting"], "color": "#3E7A4C"},
    "Badger": {"gender": "M", "tags": ["Whimsical", "Character"], "color": "#6B4F3A"},
    "Meadow": {"gender": "F", "tags": ["Warm", "Gentle"], "color": "#4C9A83"},
    "Abbey": {"gender": "F", "tags": ["British", "Refined"], "color": "#A4536B"},
    "Avonlea": {"gender": "F", "tags": ["Bright", "Youthful"], "color": "#8C6DAE"},
    "Sunshine": {"gender": "F", "tags": ["Cheery", "Light"], "color": "#E0B33C"},
